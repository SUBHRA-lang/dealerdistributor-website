        ...
        <div className="lg:w-1/2 space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Card className="border-none shadow-sm bg-white p-6 rounded-2xl">
              ...
              <p className="text-sm text-gray-500">support@dealerdistributors.com</p>
            </Card>
            <Card className="border-none shadow-sm bg-white p-6 rounded-2xl">
              ...
              <p className="text-sm text-gray-500">+91 11 4123 4567</p>
            </Card>
          </div>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <Input required className="pl-12 py-6 rounded-xl border-gray-100 bg-gray-50" placeholder="John Doe" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <Input className="pl-12 py-6 rounded-xl border-gray-100 bg-gray-50" placeholder="Acme Corp" />
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <Input required className="pl-12 py-6 rounded-xl border-gray-100 bg-gray-50" placeholder="98765 43210" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <Input required type="email" className="pl-12 py-6 rounded-xl border-gray-100 bg-gray-50" placeholder="john@example.com" />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <Input required className="pl-12 py-6 rounded-xl border-gray-100 bg-gray-50" placeholder="e.g. Website Experience" />
                  </div>
                </div>
