            ...
            <Card className="shadow-lg">
              <CardContent className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button type="submit" size="lg" className="w-full md:w-auto bg-[#2C3E95] hover:bg-[#1f2d6b] rounded-full px-8">
                    Send Message
                  </Button>
                </form>
              </CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">helpdesk@getdistributors.com</p>
                      <p className="text-gray-600">support@getdistributors.com</p>
                    </div>
                  </div>
